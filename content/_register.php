                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="text-center mb-5">
                            <a href="landingpage_home.php" class="logo"><img src="images/LogoHMCWhite.png" height="40s" alt="logo"></a>
                    ...
                    <div class="col-xl-5 col-sm-8">
                        <div class="card">
                            <div class="card-body p-4">
                                <div class="p-2">
                                    <h5 class="mb-5 text-center">Register Akun HMC</h5>
                                    <p class="text-center">Tidak ada waktu yang lebih baik dari sekarang untuk mulai merawat kesehatan mental Anda. Bergabunglah dengan Healthy Mental Circle (HMC) hari ini dan temukan dukungan yang Anda butuhkan untuk menghadapi tantangan hidup dengan lebih percaya diri.</p>
